        ...
        try {
            ...
            for (let i = headerRowIndex + 1; i < rawData.length; i++) {
                ...
                const companyData = {
                    ...
                    contato_principal_nome: this.preserveOriginalValue(row[56]),
                    contato_principal_cargo: this.preserveOriginalValue(row[57]),
                    contato_principal_email: this.preserveOriginalValue(row[58]),
                    contato_principal_celular: this.preserveOriginalValue(row[59]),
                    plano_contratado: this.preserveOriginalValue(row[60]),
                    sla: this.preserveOriginalValue(row[61]),
                    bpo_contabil: this.preserveOriginalValue(row[62]),
                    bpo_fiscal: this.preserveOriginalValue(row[63]),
                    bpo_folha: this.preserveOriginalValue(row[64]),
                    bpo_financeiro: this.preserveOriginalValue(row[65]),
                    bpo_rh: this.preserveOriginalValue(row[66]),
                    bpo_cnd: this.preserveOriginalValue(row[67]),
                    vl_bpo_contabil: this.preserveOriginalValue(row[68]),
                    vl_bpo_fiscal: this.preserveOriginalValue(row[69]),
                    vl_bpo_folha: this.preserveOriginalValue(row[70]),
                    vl_bpo_financeiro: this.preserveOriginalValue(row[71]),
                    vl_bpo_rh: this.preserveOriginalValue(row[72]),
                    vl_bpo_legal: this.preserveOriginalValue(row[73]),
                    honorario_mensal_total: this.preserveOriginalValue(row[74]),
                    competencia_inicial_fixo: this.parseDate(row[75]),
                    diversos_inicial: this.preserveOriginalValue(row[76]),
                    competencia_diversos_inicial: this.parseDate(row[77]),
                    vl_diversos_inicial: this.preserveOriginalValue(row[78]),
                    implantacao: this.preserveOriginalValue(row[79]),
                    vencimento_implantacao: this.preserveOriginalValue(row[80]),
                    forma_pgto: this.preserveOriginalValue(row[81]),
                    vl_implantacao: this.preserveOriginalValue(row[82]),
                    bpo_contabil_faturado: this.preserveOriginalValue(row[83]),
                    bpo_fiscal_faturado: this.preserveOriginalValue(row[84]),
                    bpo_folha_faturado: this.preserveOriginalValue(row[85]),
                    bpo_financeiro_faturado: this.preserveOriginalValue(row[86]),
                    bpo_rh_faturado: this.preserveOriginalValue(row[87]),
                    bpo_legal_faturado: this.preserveOriginalValue(row[88]),
                    diversos_in_faturado: this.preserveOriginalValue(row[89]),
                    implantacao_faturado: this.preserveOriginalValue(row[90]),
                    closer: this.preserveOriginalValue(row[91]),
                    prospector: this.preserveOriginalValue(row[92]),
                    origem_lead: this.preserveOriginalValue(row[93]),
                    observacao_closer: this.preserveOriginalValue(row[94]),
                    motivo_troca: this.preserveOriginalValue(row[95])
                };
