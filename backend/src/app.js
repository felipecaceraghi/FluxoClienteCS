...
const planilhaSearchRoutes = require('./routes/planilha-search.routes');
const xlsxGeneratorRoutes = require('./routes/xlsx-generator.routes');
const xlsxSaidaGeneratorRoutes = require('./routes/xlsx-saida-generator.routes');
...
app.use('/api/planilha-search', planilhaSearchRoutes);
app.use('/api/xlsx-generator', xlsxGeneratorRoutes);
app.use('/api/xlsx-saida', xlsxSaidaGeneratorRoutes);
